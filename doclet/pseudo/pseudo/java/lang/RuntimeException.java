...
/**
 * {@code RuntimeException} is the superclass of those exceptions that can be thrown during the normal operation of the
 * Java Virtual Machine.
 * <p>
 * {@code RuntimeException} and its subclasses are <em>unchecked exceptions</em>. Unchecked exceptions do <em>not</em>
 * need to be declared in a method or constructor's {@code throws} clause if they can be thrown by the execution of the
...
public class RuntimeException extends Exception {
	 ...
	 * @since 1.7
	 */
	protected RuntimeException(String message, java.lang.Throwable cause, boolean enableSuppression,
