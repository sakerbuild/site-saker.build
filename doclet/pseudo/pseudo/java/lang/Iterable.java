...
/**
 * Implementing this interface allows an object to be the target of the "for-each loop" statement. See <strong>
 * <a href="{@docRoot}/../technotes/guides/language/foreach.html">For-each Loop</a> </strong>
 *
 * @param <T>
...
public interface Iterable<T> {
	 ...
	 *               spliterator from the iterable's {@code Iterator}. The spliterator inherits the <em>fail-fast</em>
	 ...
	 *               implementation has poor splitting capabilities, is unsized, and does not report any spliterator
	 *               characteristics. Implementing classes can nearly always provide a better implementation.
