...
/**
 * The class {@code Exception} and its subclasses are a form of {@code Throwable} that indicates conditions that a
 * reasonable application might want to catch.
 * <p>
 * The class {@code Exception} and any subclasses that are not also subclasses of {@link RuntimeException} are
...
public class Exception extends Throwable {
	 ...
	 * @since 1.7
	 */
	protected Exception(String message, java.lang.Throwable cause, boolean enableSuppression,
