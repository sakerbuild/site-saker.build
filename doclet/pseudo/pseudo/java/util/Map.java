...
public interface Map<K, V> {
	 ...
	 * @throws NullPointerException
	 *             if the specified map is null, or if this map does not permit null keys or values, and the specified
	...
	interface Entry<K, V> {
		 ...
		 *             implementations may, but are not required to, throw this exception if the entry has been removed
		 ...
		 * <p>
		 * The returned comparator is serializable and throws {@link NullPointerException} when comparing an entry with
		 * a null key.
		 *
		 * @param <K>
	 ...
	 * for the key.
	 *
	 * @implSpec The default implementation makes no guarantees about synchronization or atomicity properties of this
	 *               method. Any implementation providing atomicity guarantees must override this method and document
	 ...
	 * been processed or the function throws an exception. Exceptions thrown by the function are relayed to the caller.
	 *
	 * @implSpec
	 *               <p>
	 ...
	 * @throws UnsupportedOperationException
	 *             if the {@code set} operation is not supported by this map's entry set iterator.
	 * @throws ClassCastException
	 *             if the class of a replacement value prevents it from being stored in this map
	 * @throws NullPointerException
	 *             if the specified function is null, or the specified replacement value is null, and this map does not
	 *             permit null values
	 * @throws ClassCastException
	 *             if a replacement value is of an inappropriate type for this map
	 *             (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws NullPointerException
	 *             if function or a replacement value is null, and this map does not permit null keys or values
	 *             (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws IllegalArgumentException
	 *             if some property of a replacement value prevents it from being stored in this map
	 *             (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws ConcurrentModificationException
	 *             if an entry is found to be removed during iteration
	 * @since 1.8
	 ...
	 *             key. (A {@code null} return can also indicate that the map previously associated {@code null} with
	 ...
	 *               </pre>
	 *
	 *               The default implementation does not throw NullPointerException for maps that do not support null
	 *               values if oldValue is null unless newValue is also null.
	 *               <p>
	 *               The default implementation makes no guarantees about synchronization or atomicity properties of
	 *               this method. Any implementation providing atomicity guarantees must override this method and
	 *               document its concurrency properties.
	 ...
	 * <p>
	 * If the function returns {@code null} no mapping is recorded. If the function itself throws an (unchecked)
	 ...
	 * </pre>
	 * <p>
	 * Or to implement a multi-value map, {@code Map<K,Collection<V>>}, supporting multiple values per key:
	 *
	 * <pre>
	 *  {@code
	 ...
	 * </pre>
	 *
	 * @implSpec The default implementation is equivalent to the following steps for this {@code map}, then returning
	 *               the current value or {@code null} if now absent:
	 *
	 *               <pre>
	 *  {@code
	 * if (map.get(key) == null) {
	 ...
	 *               The default implementation makes no guarantees about synchronization or atomicity properties of
	 *               this method. Any implementation providing atomicity guarantees must override this method and
	 *               document its concurrency properties. In particular, all implementations of subinterface
	 ...
	 * @throws NullPointerException
	 *             if the specified key is null and this map does not support null keys, or the remappingFunction is
	 *             null
	 * @throws UnsupportedOperationException
	 *             if the {@code put} operation is not supported by this map
	 *             (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 ...
	 * <p>
	 * If the function returns {@code null}, the mapping is removed (or remains absent if initially absent). If the
	 ...
	 * or removes if the result is {@code null}. This method may be of use when combining multiple mapped values for a
	 * key. For example, to either create or append a {@code String msg} to a value mapping:
	 *
	 * <pre>
	 *  {@code
	 ...
	 * @param value
	 *            the non-null value to be merged with the existing value associated with the key or, if no existing
	 ...
	 *             (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws NullPointerException
	 *             if the specified key is null and this map does not support null keys or the value or
