...
public class EOFException extends IOException {
	...
	/**
	 * Constructs an <code>EOFException</code> with the specified detail message. The string <code>s</code> may later be
	 * retrieved by the <code>{@link java.lang.Throwable#getMessage}</code> method of class
